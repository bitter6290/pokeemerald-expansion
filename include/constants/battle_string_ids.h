...
#define STRINGID_NEWMECHANICS STRINGID_STOCKPILEDEFFECTWOREOFF

#define STRINGID_DARKTERRAINENDS					  STRINGID_NEWMECHANICS + 1
#define STRINGID_ROCKYTERRAINENDS					  STRINGID_NEWMECHANICS + 2
...
#define STRINGID_NEWABILITIES						  LASTSTRINGID_NEWMECHANICS

#define STRINGID_ACCELERATEACTIVATES				  STRINGID_NEWABILITIES + 1
#define STRINGID_STASISACTIVATES					  STRINGID_NEWABILITIES + 2
#define STRINGID_TERRAINLOCK						  STRINGID_NEWABILITIES + 3

#define LASTSTRINGID_NEWABILITIES					  STRINGID_TERRAINLOCK


#define BATTLESTRINGS_COUNT                           LASTSTRINGID_NEWABILITIES
