...
#define MOVE_SOARING_KICK 		MOVES_CUSTOM + 2	//Anim needed
#define MOVE_BOLT_KICK 			MOVES_CUSTOM + 3	//830
#define MOVE_FROST_KICK 		MOVES_CUSTOM + 4	
#define MOVE_PRESSURE_POINT		MOVES_CUSTOM + 5	//Anim needed
#define MOVE_STRANGE_SYMPHONY 	MOVES_CUSTOM + 6	//Anim needed
#define MOVE_ECTOBLAST			MOVES_CUSTOM + 7	//Anim needed
