...
#define EFFECT_ATTACKER_SPD_DOWN_HIT		CUSTOM_BM_EFFECTS + 3
#define EFFECT_PRESSUREPOINT 				CUSTOM_BM_EFFECTS + 4

#define NUM_BATTLE_MOVE_EFFECTS             EFFECT_PRESSUREPOINT + 1
