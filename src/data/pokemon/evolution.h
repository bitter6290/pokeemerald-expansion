const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_VENUSAUR]              = {{EVO_MEGA_EVOLUTION, ITEM_VENUSAURITE, SPECIES_VENUSAUR_MEGA},
    									{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_VENUSAUR_MEGA_Y}}, //!Missing: Venusaurite Y
    ...
    [SPECIES_BLASTOISE]             = {{EVO_MEGA_EVOLUTION, ITEM_BLASTOISINITE, SPECIES_BLASTOISE_MEGA},
    									{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_BLASTOISE_MEGA_Y}}, //!Missing: Blastoisite Y
...
// Custom
	...
	[SPECIES_KRICKETUNE]            = {{EVO_ITEM, ITEM_DAWN_STONE, SPECIES_KRICKETON},
									{EVO_LEVEL, 30, SPECIES_KRICKALLOUS}},
    ...
    [SPECIES_ARBOK]                 = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_ARBOK_MEGA}}, //!Missing: Arbokite
    [SPECIES_KABUTOPS]              = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_KABUTOPS_MEGA}}, //!Missing: Kabutite
    [SPECIES_OMASTAR]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_OMASTAR_MEGA}}, //!Missing: Omastarite
    [SPECIES_FLAREON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_FLAREON_MEGA}}, //!Missing: Flareonite
    [SPECIES_VAPOREON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_VAPOREON_MEGA}}, //!Missing: Vaporeonite
    [SPECIES_JOLTEON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_JOLTEON_MEGA}}, //!Missing: Jolteonite
    [SPECIES_ESPEON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_ESPEON_MEGA}}, //!Missing: Espeonite
    [SPECIES_UMBREON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_UMBREON_MEGA}}, //!Missing: Umbreonite
    [SPECIES_LEAFEON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_LEAFEON_MEGA}}, //!Missing: Leafeonite
    [SPECIES_GLACEON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_GLACEON_MEGA}}, //!Missing: Glaceonite
    [SPECIES_SYLVEON]               = {{EVO_MEGA_EVOLUTION, ITEM_BURN_HEAL, SPECIES_SYLVEON_MEGA}}, //!Missing: Sylveonite
};
