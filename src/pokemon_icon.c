...
const u8 *const gMonIconTable[] =
{
	...
	[SPECIES_POLTENDULA] = gMonIcon_Poltendula,
	[SPECIES_ARIDOSPID] = gMonIcon_Aridospid,
	...
	[SPECIES_WINTER_PLUME] = gMonIcon_WinterPlume,
	[SPECIES_IRON_CORDS] = gMonIcon_IronCords,
	...
	[SPECIES_SANDYGAST_KANTO] = gMonIcon_SandygastKanto,
	[SPECIES_SANDILE_KANTO] = gMonIcon_SandileKanto,
	[SPECIES_KROKOROK_KANTO] = gMonIcon_KrokorokKanto,
	[SPECIES_SURSKIT_KANTO] = gMonIcon_SurskitKanto,
	[SPECIES_MASQUERAIN_KANTO] = gMonIcon_MasquerainKanto,
	[SPECIES_GIBLE_KANTO] = gMonIcon_GibleKanto,
	[SPECIES_GABITE_KANTO] = gMonIcon_GabiteKanto,
	[SPECIES_GARCHOMP_KANTO] = gMonIcon_GarchompKanto,
	[SPECIES_ARBOK_MEGA] = gMonIcon_ArbokMega,
	[SPECIES_BLASTOISE_MEGA_Y] = gMonIcon_BlastoiseMegaY,
	[SPECIES_VENUSAUR_MEGA_Y] = gMonIcon_VenusaurMegaY,
	[SPECIES_OMASTAR_MEGA] = gMonIcon_OmastarMega,
	[SPECIES_KABUTOPS_MEGA] = gMonIcon_KabutopsMega,
	[SPECIES_FLAREON_MEGA] = gMonIcon_FlareonMega,
	[SPECIES_VAPOREON_MEGA] = gMonIcon_VaporeonMega,
	[SPECIES_JOLTEON_MEGA] = gMonIcon_JolteonMega,
	[SPECIES_ESPEON_MEGA] = gMonIcon_EspeonMega,
	[SPECIES_UMBREON_MEGA] = gMonIcon_UmbreonMega,
	[SPECIES_LEAFEON_MEGA] = gMonIcon_LeafeonMega,
	[SPECIES_GLACEON_MEGA] = gMonIcon_GlaceonMega,
	[SPECIES_SYLVEON_MEGA] = gMonIcon_SylveonMega,
	[SPECIES_CROBAT_MEGA] = gMonIcon_CrobatMega,
...
#endif
	// Custom
	[SPECIES_KRICKALLOUS] = 0, //!Missing: Need icon palette
	[SPECIES_KRICKETON] = 0, //!Missing: Need icon palette
	[SPECIES_LEDENNA] = 0, //!Missing: Need icon palette
	[SPECIES_ALOOBAT] = 0, //!Missing: Need icon palette
	[SPECIES_MORADILE] = 0, //!Missing: Need icon palette
	[SPECIES_POLTENDULA] = 0, //!Missing: Need icon palette
	[SPECIES_ARIDOSPID] = 0, //!Missing: Need icon palette
	[SPECIES_FAUVANTIC] = 0, //!Missing: Need icon palette
	[SPECIES_FLORESTIC] = 0, //!Missing: Need icon palette
	[SPECIES_TERRANTIC] = 0, //!Missing: Need icon palette
	[SPECIES_AUREATIC] = 0, //!Missing: Need icon palette
	[SPECIES_WINTER_PLUME] = 0, //!Missing: Need icon palette
	[SPECIES_IRON_CORDS] = 0, //!Missing: Need icon palette
	[SPECIES_SHINX_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_LUXIO_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_LUXRAY_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_TIMBURR_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_GURDURR_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_CONKELDURR_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_LITWICK_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_LAMPENT_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_CHANDELURE_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_TORKOAL_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_SANDYGAST_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_SANDILE_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_KROKOROK_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_SURSKIT_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_MASQUERAIN_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_GIBLE_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_GABITE_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_GARCHOMP_KANTO] = 0, //!Missing: Need icon palette
	[SPECIES_ARBOK_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_BLASTOISE_MEGA_Y] = 0, //!Missing: Need icon palette
	[SPECIES_VENUSAUR_MEGA_Y] = 0, //!Missing: Need icon palette
	[SPECIES_OMASTAR_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_KABUTOPS_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_FLAREON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_VAPOREON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_JOLTEON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_ESPEON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_UMBREON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_LEAFEON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_GLACEON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_SYLVEON_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_CROBAT_MEGA] = 0, //!Missing: Need icon palette
	[SPECIES_RAPIDASH_MEGA] = 0, //!Missing: Need icon palette
    [SPECIES_EGG] = 1,
};
