...
#define MAP_GROUP_TOWNS_AND_ROUTES 66 //MAP_GROUP(PETALBURG_CITY)
#define MAP_GROUP_DUNGEONS 99 //MAP_GROUP(METEOR_FALLS_1F_1R)
#define MAP_GROUP_SPECIAL_AREA 33 //MAP_GROUP(SAFARI_ZONE_NORTHWEST)
